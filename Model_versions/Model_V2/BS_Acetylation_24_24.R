...
input <- "BS_Acetylation_24_24_mcmc_hierarchical.in.R"
...
out_final = lapply(out, setNames, colnames_para)
endparms = length(names(out_final[[1]]))-3
parms_name_1 <- paste((names(out_final[[1]])[2:endparms]),sep = ",")
out1 = list(out_final[[2]],out_final[[3]],
            out_final[[5]],out_final[[6]])
out1 = list(out_final[[1]],out_final[[2]],out_final[[3]],out_final[[4]],out_final[[5]],out_final[[6]],
            out_final[[7]],out_final[[9]],out_final[[10]])



sims = mcmc_array(data = out_final,start_sampling = 0)
